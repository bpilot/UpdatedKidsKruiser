...
getLocation: function(operationType)
    ...
    scanBadge: function(operationType, locationObj)
    {
        ...
        var self = this;
        try {
            window.plugins.barcodeScanner.scan(function(result) { self.reportOperationToHQ(operationType, result, locationObj); }, function(reason) { alert("SCAN FAILURE"); alert(reason); });
        }
